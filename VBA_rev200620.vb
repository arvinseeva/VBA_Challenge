...
For Each ws In Worksheets
    ...
    Dim tickerprofit As String
    Dim tickerloss As String
    ...
    For g = 2 To lastrow2
        ...
        tickerprofit = ws.Cells(g, 9).Value
        
        
        If ws.Cells(g, 10).Value < greatloss Then
        greatloss = ws.Cells(g, 10).Value
        tickerloss = ws.Cells(g, 9).Value
        
        If ws.Cells(g, 12).Value > greatvolume Then
        greatvolume = ws.Cells(g, 12).Value
        tickervolume = ws.Cells(g, 9).Value
    ...
    ws.Cells(2, 17).Value = tickerprofit
    ws.Cells(2, 18).Value = greatprofit
    ws.Cells(3, 17).Value = tickerloss
    ws.Cells(3, 18).Value = greatloss
    ws.Cells(4, 18).Value = greatvolume
...
'this program takes an extraordinary amount of time to compute results. 
